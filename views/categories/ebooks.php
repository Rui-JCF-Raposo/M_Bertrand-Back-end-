...
<body class="categories-body">
    ...
    <aside id="categories" class="categories-col-10">
        ...
        <div class="books-by-lang">
            ...
            <ul>
                <li><a href="../loggedIn/categoriesSpanish.html">Saúde</a></li>
                <hr class="categories-hr">
                <li><a href="../loggedIn/categoriesEnglish.html">IT</a></li>
                <hr class="categories-hr">
                <li><a href="../loggedIn/categoriesFrench.html">Psicologia</a></li>
            </ul>
        </div>

        <div class="ebooks">
            <a href="../loggedIn/categoriesEBooks.html">
                <h1 class="active-category"><strong>EBOOKS</strong></h1>
            </a>
        </div>
