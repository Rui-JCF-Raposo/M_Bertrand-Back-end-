...
<body class="categories-body">
    ...
    <aside id="categories" class="categories-col-10">
        ...
        <div class="books-by-lang">
            ...
            <ul>
                <li><a href="../loggedIn/categoriesSpanish.html">EM ESPANHOL</a></li>
                <hr class="categories-hr">
                <li><a href="../loggedIn/categoriesEnglish.html"><strong class="active-category">EM INGLÊS</strong></a></li>
                <hr class="categories-hr">
    ...
    <main>
        ...
        <section id="english-books"></section>
    </main>
</body>
